    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.code === 'ERR_NETWORK') {
                setError('Tidak dapat terhubung ke server. Pastikan backend sudah dijalankan.');
                    ...
                    <div className="glass rounded-2xl p-8 shadow-xl">
                        <div className="text-center mb-8">
                            <h1 className="text-3xl font-bold mb-2">
                                <BlurText text="Selamat Datang" className="text-foreground" />
                            </h1>
                            <p className="text-foreground/60">Masuk ke akun Anda</p>
                        </div>
                        ...
                        <p className="text-center text-foreground/60 mt-6">
                            Belum punya akun?{' '}
                            <Link href="/register" className="text-primary hover:text-secondary transition">
                                Daftar sekarang
                            </Link>
                        </p>
                    </div>
